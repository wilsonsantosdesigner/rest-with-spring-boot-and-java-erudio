...
public interface BookControllerDocs {
    ...
    @Operation(summary = "Adds a new Book",
        description = "Adds a new book by passing in a JSON," +
                " XML or YML representation of the book.",
        tags = {"Book"},
        responses = {
            @ApiResponse(
                description = "Success",
    ...
    @Operation(summary = "Updates a book's information",
        description = "Updates a book's information by " +
                "passing in a JSON, XML or YML representation of " +
                "the updated book.",
        tags = {"Book"},
        responses = {
            @ApiResponse(
